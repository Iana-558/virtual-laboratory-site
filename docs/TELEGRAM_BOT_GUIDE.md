...
<img src="chart.png" alt="Схема обработки сообщения пользователя" width="500">
Рисунок 1 – Схема взаимодействия клиент-сервер

<img src="chart_2.png" alt="Структура обработчиков сообщений" width="500">
...
<img src="botfather2.jpg" alt="Создание бота" width="200"> <img src="botfather1.jpg" alt="BotFather" width="200">
...
<img src="bot1.jpg" alt="Выполнение команд" width="200"> <img src="bot2.jpg" alt="Выполнение команд" width="200"> 
<img src="bot3.jpg" alt="Выполнение команд" width="200"> 
...
Прямая ссылка для просмотра: [bot.mp4](bot.mp4)
