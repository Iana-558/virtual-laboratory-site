...
![Схема обработки сообщения пользователя](chart.png)
*Рисунок 1 – Схема взаимодействия клиент-сервер*

![Структура обработчиков сообщений](chart_2.png)
...
![Структура обработчиков сообщений](botfather1.png)
![Структура обработчиков сообщений](botfather2.png)
...
![Выполнение ботом команд](bot1.png)
![Выполнение ботом команд](bot2.png)
![Выполнение ботом команд](bot3.png)
